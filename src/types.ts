...
export function normalizeLoadSettings(raw: Partial<LlamaLoadSettings> | undefined): LlamaLoadSettings {
  ...
  return {
    ...
    offloadKvCacheToGpu: s.offloadKvCacheToGpu ?? d.offloadKvCacheToGpu,
    cacheTypeK: normalizeKvCacheType(s.cacheTypeK),
    cacheTypeV: normalizeKvCacheType(s.cacheTypeV),
    keepModelInMemory: s.keepModelInMemory ?? d.keepModelInMemory,
    tryMmap: s.tryMmap ?? d.tryMmap,
    unifiedKvCache: s.unifiedKvCache ?? d.unifiedKvCache,
    ...
    speculativeMode: s.speculativeMode === "mtp" ? "mtp" : "off",
