...
export function discoverModelRoots(config: vscode.WorkspaceConfiguration): ScanRoot[] {
...
export function listLocalModelEntries(config: vscode.WorkspaceConfiguration): LocalModelEntry[] {
